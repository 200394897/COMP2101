...
myargs=()
#here, identifying the input by creating variables.
vmodes=0
dmodes=0
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  #here, iam shifting a command line for processing a next element.
  ;;
  esac
...
#here, using if condition for checking the state of this variable
if [ $vmodes = 1 ]; then
...
#here, using if condition for checking the state of this variable
if [ $dmodes -gt 0 ]; then
  echo "Debug Mode is On with debug level $dmodes."
else
