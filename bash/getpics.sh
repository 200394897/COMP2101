...
#  if we don’t have any tar in picture directory then we have to download it. 
...
# we have to delete local copy of zipfile after the tarfile after extracting it
